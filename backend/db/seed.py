...
CAMERAS_DATA = [
    ...
    # 30 Real Sandbox CCTV Cameras (cctv.corp8.cloud)
    ("cam01", "01 Chiman bhai Bridge", "Police", "Ahmedabad", 23.0645, 72.5850, "Online", settings.build_rtsp_url("cam01"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam02", "02 Janpath", "Municipal Corp", "Ahmedabad", 23.0320, 72.5650, "Online", settings.build_rtsp_url("cam02"), "Genetec", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam03", "03 O.N.G.C. Office", "Police", "Ahmedabad", 23.0980, 72.5850, "Online", settings.build_rtsp_url("cam03"), "Milestone", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam04", "04 Paldi Circle", "Police", "Ahmedabad", 23.0125, 72.5620, "Online", settings.build_rtsp_url("cam04"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam05", "05 Visat teen Rasta", "Transport (RTO)", "Gandhinagar", 23.1110, 72.5920, "Online", settings.build_rtsp_url("cam05"), "ONVIF_NVR", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam06", "06 Timbavadi gate-Junagadh", "Police", "Junagadh", 21.5050, 70.4480, "Online", settings.build_rtsp_url("cam06"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam07", "07 hero-showroom-gir-somnath", "Police", "Gir Somnath", 20.9020, 70.3700, "Online", settings.build_rtsp_url("cam07"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam08", "08 majewadi-gate-junagadh", "Police", "Junagadh", 21.5280, 70.4650, "Online", settings.build_rtsp_url("cam08"), "Milestone", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam09", "09 new-bypass-near-by-circle-junagadh-2", "Transport (RTO)", "Junagadh", 21.5350, 70.4750, "Online", settings.build_rtsp_url("cam09"), "ONVIF_NVR", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam10", "10 char-chowk-road-2-junagadh", "Municipal Corp", "Junagadh", 21.5190, 70.4590, "Online", settings.build_rtsp_url("cam10"), "Genetec", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam11", "11 dolatpara-junagadh", "Police", "Junagadh", 21.5450, 70.4720, "Online", settings.build_rtsp_url("cam11"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam12", "12 Tri Mandir Adalaj Tollnaka", "Transport (RTO)", "Gandhinagar", 23.1680, 72.5820, "Online", settings.build_rtsp_url("cam12"), "ONVIF_NVR", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam13", "13 CN Vidhyalaya", "Police", "Ahmedabad", 23.0230, 72.5480, "Online", settings.build_rtsp_url("cam13"), "Milestone", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam14", "14 Delight RLVD", "Municipal Corp", "Ahmedabad", 23.0450, 72.5180, "Online", settings.build_rtsp_url("cam14"), "Genetec", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam15", "15 Suvidha park", "Municipal Corp", "Ahmedabad", 23.0080, 72.5350, "Online", settings.build_rtsp_url("cam15"), "Genetec", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam16", "16 Visat P2", "Police", "Gandhinagar", 23.1120, 72.5930, "Online", settings.build_rtsp_url("cam16"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam17", "17 Rajkot Bus Port CCTV", "GSRTC", "Rajkot", 22.3020, 70.8045, "Online", settings.build_rtsp_url("cam17"), "Milestone", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam18", "18 Rajkot CCTV", "Police", "Rajkot", 22.2980, 70.7990, "Online", settings.build_rtsp_url("cam18"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam19", "19 KHAPARIA GRAM PANCHAYAT, TALUKA GANDEVI, DISTRICT NAVSARI", "Panchayat", "Navsari", 20.8520, 72.9850, "Online", settings.build_rtsp_url("cam19"), "ONVIF_NVR", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam20", "20 Mohanpura", "Police", "Ahmedabad", 23.0290, 72.5980, "Online", settings.build_rtsp_url("cam20"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam21", "23 Patan Dethali Char Rasta", "Police", "Patan", 23.8450, 72.1280, "Online", settings.build_rtsp_url("cam21"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam22", "28 BK Mervada tran Rasta", "Police", "Banaskantha", 24.1720, 72.4350, "Online", settings.build_rtsp_url("cam22"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam23", "30 kheram", "Panchayat", "Mehsana", 23.6020, 72.4150, "Online", settings.build_rtsp_url("cam23"), "ONVIF_NVR", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam24", "33 dehgam", "Police", "Gandhinagar", 23.1680, 72.8120, "Online", settings.build_rtsp_url("cam24"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam25", "34 dhanori", "Panchayat", "Navsari", 20.9150, 73.0120, "Online", settings.build_rtsp_url("cam25"), "ONVIF_NVR", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam26", "35 TANKAL", "Police", "Surat", 21.0520, 73.1250, "Online", settings.build_rtsp_url("cam26"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam27", "36 bilimora", "Municipal Corp", "Navsari", 20.7650, 72.9650, "Online", settings.build_rtsp_url("cam27"), "Genetec", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam28", "37 bilimora", "Transport (RTO)", "Navsari", 20.7680, 72.9720, "Online", settings.build_rtsp_url("cam28"), "ONVIF_NVR", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam29", "38 bilimora", "Police", "Navsari", 20.7720, 72.9810, "Online", settings.build_rtsp_url("cam29"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
    ("cam30", "Gandhidham Rambaugh p2", "Police", "Kutch", 23.0780, 70.1320, "Online", settings.build_rtsp_url("cam30"), "Direct_IP", "2024-01-01", "1080p", 1, "2026-09-11T08:00:00Z"),
]
