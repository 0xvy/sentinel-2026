...
def _enhance_plate_crop(crop: np.ndarray) -> np.ndarray:
    """
    Enhance plate crop image for improved OCR character separation:
    ...
    3. CLAHE contrast adjustment on LAB L-channel to normalize lighting/glare
    """
    ...
    # 3. LAB color space CLAHE contrast equalization on L-channel
